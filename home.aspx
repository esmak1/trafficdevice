<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="TrafficWebApplication.home" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TrafficDataConnectionString %>" SelectCommand="SELECT [Direction], [DateTime] FROM [TrafficTable]"></asp:SqlDataSource>
        </div>
